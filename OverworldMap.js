class OverworldMap {
  ...
  /*
  * Visualizza le celle cliccabili sulla mappa
  */
  showClickableCells(cells) {

    // aggiunge le celle cliccabili alla lita di oggetti
    Object.keys(cells).forEach( key => {

      //console.log(cell);
      const pos = key.split(",");
//      console.log(key, Number(pos[0]), Number(pos[1]));
      ...
      let instance = new ClickableCell(config);
...
window.OverworldMaps = {
  StartingGround: {
    id: "DemoRoom",
    lowerSrc: "/images/maps/001-starting-ground.png",
    upperSrc: "",
    configObjects: {
      hero: {
        type: "Person",
        ...
        items: [],
        spells: [],
        movement: { sides: 6, number: 2 },
        attack: { sides: 6, number: 3 },
        defense: { sides: 6, number: 2 },
        hp: 100
        // [fab] <<
      },
      npcA: {
      ...
      npcB: {
        ...
        talking: [
          {
            events: [
              { type: "textMessage", text: "Sbluarrgh!", faceHero: "npcB" },
